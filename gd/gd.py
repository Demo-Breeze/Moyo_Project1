...
class Geometry_Dash:
    ...
    def run(self):
        ...
        # Level / game state stuff for the percent bar, win screen, pause screen, start and losing
        LEVEL_LENGTH = 9000      # how far (same units g_move scrolls) you need to go to win
        distance_traveled = 0.0  # how far we've scrolled so far, drives the percent bar + win check
        game_state = "start"   # "playing", "paused", "win", "lose","start"
        ...
        while running:
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.KEYDOWN:
                    ...
                    if event.key == pygame.K_r:
                        ...
                        if game_state in ("win", "lose","start"):
            ...
            # Pause / win / lose/ Start overlays
            if game_state == "start":
                message, color = "Press Enter to Start", (255, 255, 255)
